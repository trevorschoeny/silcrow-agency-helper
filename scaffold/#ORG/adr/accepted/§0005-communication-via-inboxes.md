...
- **Neutral:** Narrow, well-defined exceptions exist (see `../../docs/message-protocol.md` §8) for genuine real-time clarification and for urgent escalations; these must be recorded afterward.

## References

- `../../docs/foundations/03-actor-model.md` — full intellectual history and citations.
- `../../docs/message-protocol.md` — operational rules.
