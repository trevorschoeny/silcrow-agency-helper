...
> **Retrospective note (on supersession by §0012):** The core principle this ADR
> established — the Registrar's authority is procedural, not substantive — is
> preserved in §0012. What §0012 changes is the *operating mode*: from
...
> retained in §0012; the per-proposal workflow latency is not. Read both
