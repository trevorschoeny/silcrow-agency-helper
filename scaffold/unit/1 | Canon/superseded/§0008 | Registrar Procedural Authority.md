...
> **Retrospective note (on supersession by §0010):** The core principle this ADR
> established — the Registrar's authority is procedural, not substantive — is
> preserved in §0010. What §0010 changes is the *operating mode*: from
...
> retained in §0010; the per-proposal workflow latency is not. Read both
...
- `../../3 | Silcrow Agency Reference/foundations/06 | Registrar Pattern.md` — full intellectual history.
- `../../Registrar @ {unit_name}/AGENTS.md` — operational procedures.
- `../../Registrar @ {unit_name}/AGENTS.md` — the Registrar's own instructions, which open with this stance.
