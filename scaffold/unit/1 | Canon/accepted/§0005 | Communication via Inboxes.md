...
- **Neutral:** Narrow, well-defined exceptions exist (see `../../3 | Silcrow Agency Reference/Message Protocol.md` §8) for genuine real-time clarification and for urgent escalations; these must be recorded afterward.

## References

- `../../3 | Silcrow Agency Reference/foundations/03 | Actor Model.md` — full intellectual history and citations.
- `../../3 | Silcrow Agency Reference/Message Protocol.md` — operational rules.
