...
Superseded ADRs are never deleted. They move from `CANON@{unit_name}/accepted/` to `CANON@{unit_name}/superseded/` but remain in the record. This is because:
...
- **MADR is the default template.** MADR 4.0-shaped, with Why-statement header prepended. See `../../CANON@{unit_name}/_templates/madr-full.md`.
