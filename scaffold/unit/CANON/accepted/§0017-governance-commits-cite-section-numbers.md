...
- A commit that adds `§0013` to `@{unit_name}/CANON@{unit_name}/accepted/` is a governance event; future agents will want to search for "what happened with §0013?" and find every commit that implemented it.
