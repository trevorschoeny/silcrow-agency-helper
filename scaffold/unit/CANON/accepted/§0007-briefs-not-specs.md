...
- `../../REFERENCE@{unit_name}/foundations/01-stratified-cognition.md` — the stratification this decision preserves.
- `../../REFERENCE@{unit_name}/foundations/02-subsidiarity.md` — the subsidiarity principle this decision operationalizes.
- `../../{lead_dir}@{unit_name}/AGENTS.md` — where this pattern is operationalized for the {lead_role}.
- `../../{implementer_dir}@{unit_name}/AGENTS.md` — where the receiving side is described.
- `../../REFERENCE@{unit_name}/message-protocol.md` §6 — brief/plan/report message kinds.
