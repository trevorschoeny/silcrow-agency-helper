...
On-demand audits cover form, contradictions, staleness, citation integrity, orphans, scope violations (§0020), federation-rule violations, unsafe references (§0013), unit↔ADR consistency (§0014), and git hygiene (§0017, informational). The full checklist lives in `../../registrar@{unit_name}/AGENTS.md`.
...
- `../../REFERENCE@{unit_name}/foundations/06-registrar-pattern.md` — full intellectual history of the procedural/substantive split, with a section on why the audit mode preserves it.
