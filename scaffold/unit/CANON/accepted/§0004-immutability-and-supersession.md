...
- `../../REFERENCE@{unit_name}/foundations/04-architecture-decision-records.md` — full intellectual history.
- `../../REFERENCE@{unit_name}/foundations/05-legal-citation-tradition.md` — the legal-citation parallel.
- `../../REFERENCE@{unit_name}/decision-process.md` — operational rules for supersession.
