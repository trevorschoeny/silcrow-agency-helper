...
- `../../REFERENCE@{unit_name}/foundations/05-legal-citation-tradition.md` — full intellectual history and citations.
...
- `../../REFERENCE@{unit_name}/decision-process.md` — operational rules for §-numbering in this project.
