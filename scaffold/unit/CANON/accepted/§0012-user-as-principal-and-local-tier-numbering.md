...
- **Lead @ <unit>** — first-class. May draft, commit, and supersede ADRs directly in their unit's `@{unit_name}/CANON@{unit_name}/accepted/`. No approval needed.
...
- `../../REFERENCE@{unit_name}/foundations/01-stratified-cognition.md` — cognitive-horizon framing that tier-1-of-unit, tier-2-of-unit preserve.
- `../../REFERENCE@{unit_name}/foundations/02-subsidiarity.md` — decisions at lowest competent level; User-transcends-tiers is the limit case at the top.
