...
- `../../REFERENCE@{unit_name}/foundations/07-canonical-and-operational.md` — full intellectual history covering Buchanan, Hart, Popper, Ostrom, Nygard, and the Agile analog.
- `../../REFERENCE@{unit_name}/philosophy.md` — canon/operational framing embedded in the agency's guiding principles.
