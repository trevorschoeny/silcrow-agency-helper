...
- `../../REFERENCE@{unit_name}/foundations/01-stratified-cognition.md` — full intellectual history.
- `../../REFERENCE@{unit_name}/foundations/02-subsidiarity.md` — why the tiered structure lets subsidiarity work.
- `../../REFERENCE@{unit_name}/foundations/06-registrar-pattern.md` — why the Registrar sits outside the hierarchy.
- `../../` — the directories of the starter roster this ADR directly defines. Subsequent roster changes flow through `§0010`.
