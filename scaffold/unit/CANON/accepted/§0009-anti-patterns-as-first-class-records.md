...
- `../../REFERENCE@{unit_name}/decision-process.md` — the promotion criteria for embedded → standalone.
- `../../REFERENCE@{unit_name}/foundations/04-architecture-decision-records.md` — the broader research on decision rationale preservation.
