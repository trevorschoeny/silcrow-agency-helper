...
- `../../docs/decision-process.md` — includes the promotion criteria for embedded → standalone anti-patterns
- `../../docs/philosophy.md` — the discipline that makes anti-pattern records meaningful
