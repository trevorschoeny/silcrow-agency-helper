...
because *{the deeper reason — often a principle from `docs/philosophy.md`}*.
...
{If this decision surfaced something people might mistakenly do instead, describe it here — or promote it to a standalone record in `adr/anti-patterns/` if it's reusable across future decisions. See `docs/decision-process.md` for the promotion criteria.}
...
a Y-statement header (Zimmermann, SATURN 2012) and scaffold-specific fields for
