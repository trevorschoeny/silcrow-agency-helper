...
3. **Validate.** The Registrar runs the standard validation checklist (see `docs/registrar-playbook.md`).
...
- `../../docs/registrar-playbook.md` — the validate/execute half of the procedure.
