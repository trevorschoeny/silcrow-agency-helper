...
- `../../docs/foundations/04-architecture-decision-records.md` — full intellectual history.
- `../../docs/foundations/05-legal-citation-tradition.md` — the legal-citation parallel.
- `../../docs/decision-process.md` — operational rules for supersession.
