...
- `../../docs/foundations/05-legal-citation-tradition.md` — full intellectual history and citations.
...
- `../../docs/decision-process.md` — operational rules for §-numbering in this project.
