...
- **Project-global vs. partitioned numbering.** At scale, you might want to partition § sequences by topic or module. The scaffold's default is project-global; see `../registrar-playbook.md` for the partition discussion. The key discipline either way: never restart numbering.
